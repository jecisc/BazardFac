...
(unsigned int size)
{
	...
	/* on doit couper la cellule extraite, ins\'erer dans la liste des cellules libres 
           une cellule construite dans l'espace restant */
	{
	...
	/* et retourner \`a l'utilisateur un pointeur sur l'espace allou\'e */
	return tmp->userspacestart ;
}
